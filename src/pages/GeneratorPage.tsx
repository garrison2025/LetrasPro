...
import { Trash2, Search, LayoutList, Instagram, Wand2, Star, ShieldCheck, Eye, PenTool, Moon, Gamepad2, List, TrendingUp, Bold, Layers, Home, ChevronRight, ArrowUp, Zap, Palette, Smartphone, Check, ChevronDown, MessageCircle, Type } from 'lucide-react';
    ...
    <div className="flex flex-col pb-20 dark:bg-slate-900 transition-colors duration-300">
      ...
      <div className="pt-12 pb-20 px-4 text-center">
        ...
        <nav className="flex justify-center items-center gap-2 text-sm text-slate-500 mb-6" aria-label="Breadcrumb">
          <a href="/" className="hover:text-primary-600 transition-colors flex items-center gap-1 font-medium">
            <Home size={14} /> Inicio
          </a>
