  ...
  return (
    <div className="pt-20 pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button 
                    ...
                    className={`px-3 py-2 rounded-lg text-sm font-medium border ${separator === 'newline' ? 'bg-primary-50 border-primary-500 text-primary-700' : 'bg-slate-50 border-slate-200 text-slate-600 hover:bg-white'}`}
                  >
                    Nueva Línea
                  </button>
                  <button 
                    onClick={() => setSeparator('space')}
                    className={`px-3 py-2 rounded-lg text-sm font-medium border ${separator === 'space' ? 'bg-primary-50 border-primary-500 text-primary-700' : 'bg-slate-50 border-slate-200 text-slate-600 hover:bg-white'}`}
                  >
                    Espacio
                  </button>
                  <button 
                    onClick={() => setSeparator('period')}
                    className={`px-3 py-2 rounded-lg text-sm font-medium border ${separator === 'period' ? 'bg-primary-50 border-primary-500 text-primary-700' : 'bg-slate-50 border-slate-200 text-slate-600 hover:bg-white'}`}
                  >
                    Punto
                  </button>
                  <button 
                    onClick={() => setSeparator('custom')}
                    className={`px-3 py-2 rounded-lg text-sm font-medium border ${separator === 'custom' ? 'bg-primary-50 border-primary-500 text-primary-700' : 'bg-slate-50 border-slate-200 text-slate-600 hover:bg-white'}`}
                  >
                    Otro...
                  </button>
                </div>
                {separator === 'custom' && (
                  <input 
                    ...
                    className="mt-3 w-full px-4 py-2 rounded-lg border border-slate-200 text-sm"
                  />
                )}
              </div>
        ...
        {/* SEO Content */}
        <div className="mt-24 prose prose-slate prose-lg max-w-none">
